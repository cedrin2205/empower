...
<body>
    <div class="container">
        <h1>Welcome ABM Teacher</h1>
        <a href="logout.php" class="btn btn-warning">Logout</a>
    </div>
    <div class="contain">
        <form action="abmupload.php" method="post" enctype="multipart/form-data">
        ...
        if (mysqli_num_rows($res) > 0) {
            while ($images = mysqli_fetch_assoc($res)) { ?>
                <div class="alb">
                    ...
                    <a class="delete-btn" href="abmteacher.php?delete_image=<?=$images['image_url']?>">X</a>
                </div>
            <?php }
        }
        ?>
